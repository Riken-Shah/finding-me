    ...
    <main className="min-h-screen">
      ...
      <section id="projects" className="h-screen flex items-center border-t border-white/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="group p-8 border border-white/10 hover:border-white/30 transition-colors">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="p-8 border border-white/10 hover:border-white/30 transition-colors">
              ...
              <a href="#" className="inline-flex items-center text-lg hover:text-white/80 transition-colors">
